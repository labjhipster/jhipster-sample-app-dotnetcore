...
using AuthenticationService = lab.Domain.Services.AuthenticationService;
using IAuthenticationService = lab.Domain.Services.Interfaces.IAuthenticationService;
